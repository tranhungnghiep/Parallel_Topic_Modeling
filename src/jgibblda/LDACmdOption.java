...
public class LDACmdOption {
    ...
    @Option(name = "-niters", usage = "Specify the number of iterations. Default = 1000.")
    public int niters = 1000;

    @Option(name = "-savestep", usage = "Thinning interval: Specify the number of steps to save the model since the last save. Save step = 0 means not save. Default = 100.")
